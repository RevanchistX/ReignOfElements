...
namespace SimpleMan.VisualRaycast
{
    public static class ComponentExtension
    {
        ...
        public static CastResult MakeBoxcast(Component sender, Ray ray, float maxDistance, Vector3 size, Quaternion rotation, LayerMask mask, bool castAll, bool ignoreSelf)
        {
        ...
        public static CastResult CalculateResult(RaycastHit[] hits, Component sender, bool fistHitOnly, bool ignoreSelf)
        {
